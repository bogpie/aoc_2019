...
void fRunProgram(vector <long long> vProg, long long & nBlocks,long long & finalScore)
{
	long long input = 0, relBase = 0, iProg = 0, iChar = 0, x = 0, y = 0;
	nBlocks = 0; // finalScore = 0;
	sctPoint ball = { 0,0 }, paddle = { 0,0 };
	bool isScore = 0;
...
void fPart1(vector <long long> vProg)
{
	...
	long long nBlocks = 0, finalScore = 0;
	fRunProgram(vProg, nBlocks, finalScore);
	fout << "Part 1 : " << nBlocks << "\n";
}
...
int main()
{
	...
	fPart1(vProg);
	cout << "part 1 completed, wait some seconds for part 2 ...\n";
